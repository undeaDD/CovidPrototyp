            ...
            firebase.database().ref('patients').on('value', function(snapshot) {
                ...
                var table2 = $('#table2').DataTable({
                    ...
                    "columns": [
					{
						...
						"searchable": false,
						"render": function(data, type, row, meta) {
							return "<a href='http://www.barcode-generator.org/zint/api.php?bc_number=20&bc_data=" + row.id + "' data-title='QR-Code:' data-toggle='lightbox' data-height=120 ><img height='21' class='mr-2' src='../assets/img/barcode-read.png'/></a>" +
